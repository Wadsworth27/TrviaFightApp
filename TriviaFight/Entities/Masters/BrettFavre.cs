...
{
    public class BrettFavre : Enemy
    {
        Random random = new();

        public override string Name { get; set; } = "Brett Favre";
        ...
        public override int SuggestedLevel { get; set; } = 10;
        public override int Stamina { get; set; } = 0;
        public override int DefendPercentage { get; set; } = 35;
        public override string TriviaURL { get; set; } = "https://opentdb.com/api.php?amount=10&category=21&type=multiple";
